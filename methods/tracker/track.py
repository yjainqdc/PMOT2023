...
def main(opts):
    ...
    elif opts.data_format == 'mot':
        DATA_ROOT = os.path.join('D:\work_dir\MOT20_study\MOT20\\test\MOT20-04\img1')
        seqs = os.listdir(DATA_ROOT)
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='mot', help='visdrone or mot')
    parser.add_argument('--data_format', type=str, default='mot', help='format of reading dataset')
